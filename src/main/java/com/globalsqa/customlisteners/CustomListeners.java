package com.globalsqa.customlisteners;
...
import static com.globalsqa.utility.Utility.takeScreenShot;
...
public class CustomListeners implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        reports.setSystemInfo("Devanshi Pipaliya", System.getProperty("user.name"));
